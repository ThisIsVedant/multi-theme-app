      ...
      >
        <div className="max-w-7xl mx-auto mt-10">
          ...
          <section className="text-center space-y-6 mb-20">
            ...
            <p
              className={`text-lg md:text-xl max-w-3xl mx-auto leading-relaxed ${currentTheme.textSecondary}`}
            >
              Experience the power of dynamic theming with our innovative multi-theme switcher.
              Transform your entire application&apos;s look and feel with just one click.
            </p>
          ...
          {/* Stats Section */}
          <section
            className={`${currentTheme.header} ${currentTheme.text} border-1 rounded-2xl p-8 mb-20`}
          >
