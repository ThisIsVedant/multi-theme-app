...
export default function HomePage() {
    ...
    return (
        <>
            <Sidebar/>
            <main className={`text-gray-900 min-h-screen px-6 py-12 pt-16 ${currentTheme.font} ${currentTheme.bg} ${
                ...
                <div className="max-w-7xl mx-auto mt-10">
                    ...
                    <section className="text-center space-y-6 mb-20">
                        ...
                        <p className={`text-lg md:text-xl max-w-3xl mx-auto leading-relaxed ${currentTheme.textSecondary}`}>
                            Experience the power of dynamic theming with our innovative multi-theme switcher. Transform
                            your entire
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6">
                            ...
                            <button
                                className={`${currentTheme.buttonSecondary} border-2 px-8 py-4 rounded-lg font-semibold transition`}>
                                Learn More
                            </button>
                        </div>
                    </section>
                    ...
                    {/* Stats Section */}
                    <section className={`${currentTheme.header} ${currentTheme.text} border-1 rounded-2xl p-8 mb-20`}>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {stats.map((stat, index) => (
                                <div key={index} className="text-center space-y-3">
                                    <div
                                        className="w-12 h-12 mx-auto flex items-center justify-center rounded-full bg-opacity-20"
                    ...
                    <section>
                        <div className="text-center mb-12">
                            ...
                            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                                Discover our curated collection of premium products, each one carefully selected for
                                quality and style.
                            </p>
                        </div>
                        ...
                        {loading && (
                            <div className="flex justify-center items-center py-20">
                                <div
                                    className="w-8 h-8 border-4 border-blue-200 border-t-transparent rounded-full animate-spin"></div>
                            </div>
                        )}
