...
export default function AboutPage() {
    ...
    const features = [
        {
            ...
            description: "Switch between multiple themes instantly with persistent storage and smooth animations.",
        },
        {
            icon: "💻",
        ...
        },
        {
            ...
            description: "Optimized for performance with efficient state management and smooth transitions.",
        },
    ]
    ...
    return (
        <>
            <Sidebar/>
            <main className={`${currentTheme.bg} ${currentTheme.font} ${currentTheme.text} min-h-screen px-6 py-12 pt-16 ${
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    <section className={`${currentTheme.card} rounded-2xl p-8 md:p-12 text-center mb-20`}>
                        ...
                        <p className="text-lg text-gray-600 max-w-4xl mx-auto leading-relaxed">
                            We believe that user experience should be personal and adaptable. Our mission is to create
                            applications
                            that not only function beautifully but also adapt to user preferences seamlessly. Through
                            innovative
                            theming solutions, we&apos;re pushing the boundaries of what&apos;s possible in modern web
                            development.
                        </p>
                    </section>
                    ...
                    <section className="mb-20">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                                Discover what makes MultiTheme special and how it can transform your user experience.
                            </p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            {features.map((feature, index) => (
                                ...
                                >
                                    <div
                                        className="w-12 h-12 bg-blue-100 flex items-center justify-center rounded-lg text-2xl mb-4">
                                        {feature.icon}
                                    </div>
                    ...
                    <section className={`${currentTheme.secondaryCard} rounded-2xl p-8 md:p-12 text-center`}>
                        <h2 className={`text-3xl md:text-4xl font-bold mb-6 ${currentTheme.textSecondary}`}>Built with
                            Passion</h2>
                        <p className="text-lg text-gray-700 max-w-3xl mx-auto mb-8">
                            MultiTheme was crafted by a team of passionate developers who believe in the power of great
                            design and
